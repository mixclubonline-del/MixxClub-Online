 ...
 *
 * Every block type includes shared "Style" fields (padding, background color,
 * background gradient, background image) injected automatically.
 */
...
export interface BlockFieldDef {
  ...
  defaultValue: any;
  group?: string; // used to visually group fields in the editor
}
...
/* ── Shared styling fields appended to every block type ── */
const STYLE_FIELDS: BlockFieldDef[] = [
  { key: '_paddingY', label: 'Vertical Padding', type: 'select', group: 'Style', defaultValue: 'default', options: [
  ...
  { key: '_bgColor', label: 'Background Color', type: 'color', group: 'Style', defaultValue: '' },
  { key: '_bgGradient', label: 'Background Gradient', type: 'select', group: 'Style', defaultValue: 'none', options: [
    { label: 'None', value: 'none' },
    { label: 'Primary → Secondary', value: 'primary-secondary' },
    { label: 'Dark Overlay', value: 'dark' },
    { label: 'Subtle Mist', value: 'mist' },
    { label: 'Sunset', value: 'sunset' },
    { label: 'Ocean', value: 'ocean' },
  ]},
  { key: '_bgImage', label: 'Section Background Image', type: 'image', group: 'Style', defaultValue: '' },
  { key: '_bgOverlay', label: 'Image Overlay Opacity', type: 'select', group: 'Style', defaultValue: '60', options: [
    { label: 'None', value: '0' },
    { label: 'Light (30%)', value: '30' },
    { label: 'Medium (60%)', value: '60' },
    { label: 'Heavy (80%)', value: '80' },
    { label: 'Full (95%)', value: '95' },
  ]},
  { key: '_textColor', label: 'Text Color Override', type: 'color', group: 'Style', defaultValue: '' },
  { key: '_maxWidth', label: 'Content Max Width', type: 'select', group: 'Style', defaultValue: 'default', options: [
    { label: 'Narrow (4xl)', value: 'narrow' },
    { label: 'Default (6xl)', value: 'default' },
    { label: 'Wide (7xl)', value: 'wide' },
    { label: 'Full', value: 'full' },
  ]},
];

function withStyleFields(fields: BlockFieldDef[]): BlockFieldDef[] {
  return [...fields, ...STYLE_FIELDS];
}
