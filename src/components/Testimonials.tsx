  ...
  const testimonials = [
    {
      ...
      location: "Atlanta, GA",
      rating: 5,
      text: "MixClub transformed my bedroom recordings into radio-ready tracks. The engineer understood exactly what I wanted and the AI polish made everything pop. Got my EP done for under $500 - would've cost me $3K+ at a local studio.",
    ...
    },
    {
      ...
      rating: 5,
      text: "As an independent artist, budget is everything. MixClub's pricing let me afford professional mixing for my whole album. The live collaboration feature is insane - I could hear changes in real-time and give instant feedback. Game changer.",
    ...
    },
    {
      ...
      rating: 5,
      text: "We recorded our debut album in our garage and honestly thought it sounded terrible. MixClub's engineers salvaged it and made it sound like we recorded in a million-dollar studio. The stems separation was clutch for getting clean mixes.",
      ...
      <div className="container px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join 50,000+ independent artists who've elevated their sound with MixClub. Real reviews from real musicians.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-card border border-border rounded-lg">
            ...
            <p className="text-sm">
              <span className="font-semibold text-primary">50,000+</span> artists trust MixClub
            </p>
          </div>
        </div>
      </div>
