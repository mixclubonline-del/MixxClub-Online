...
import { Heart, MessageSquare, Star, Trash2, ExternalLink } from 'lucide-react';
...
export const SavedMatches: React.FC<SavedMatchesProps> = ({ userType, searchQuery }) => {
  const savedMatches = [
    {
      id: '1',
      name: 'Alex "SoundWave" Johnson',
      avatar: '',
      matchScore: 91,
      rating: 4.8,
      specialty: 'Hip-Hop Mixing',
      savedAt: '3 days ago',
      lastActive: 'Online now',
      notes: 'Great for trap beats, responds quickly',
    },
    {
      id: '2',
      name: 'Maya "VocalFX" Williams',
      avatar: '',
      matchScore: 87,
      rating: 4.9,
      ...
      notes: 'Perfect for R&B vocals',
    },
    {
      id: '3',
      name: 'Chris "BassHead" Martinez',
      avatar: '',
      matchScore: 85,
      rating: 4.7,
      specialty: 'Bass & Low-End',
      savedAt: '2 weeks ago',
