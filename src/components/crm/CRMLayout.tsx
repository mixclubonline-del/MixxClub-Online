...
export const CRMLayout = ({ children, userType, profile, stats, quickActions, isStudioMode = false }: CRMLayoutProps) => {
  ...
  const menuItems = [
    ...
    },
    {
      title: 'Revenue',
      icon: TrendingUp,
      path: userType === 'engineer' ? '/engineer-crm?tab=revenue' : '/artist-crm?tab=revenue',
      section: 'revenue',
    },
    {
      title: 'Community',
      icon: Users,
      path: userType === 'engineer' ? '/engineer-crm?tab=community' : '/artist-crm?tab=community',
      section: 'community',
    },
    {
      title: 'Growth',
      icon: Target,
      path: userType === 'engineer' ? '/engineer-crm?tab=growth' : '/artist-crm?tab=growth',
      section: 'growth',
    },
    {
      title: 'Messages',
    ...
    },
    {
      ...
      icon: Handshake,
      path: userType === 'engineer' ? '/engineer-crm?tab=earnings' : '/artist-crm?tab=earnings',
      section: 'earnings',
    },
    {
      title: 'Profile',
