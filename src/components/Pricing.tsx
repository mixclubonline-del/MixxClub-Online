      ...
      <div className="container px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-primary/30 bg-gradient-to-r from-primary/5 to-primary/10">
            <CardHeader>
              <CardTitle className="text-2xl text-center">Why <span className="font-black tracking-wider text-primary">MIXXCLUB</span> Beats the Competition</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-lg">🎯 <span className="font-black tracking-wider text-primary">MIXXCLUB</span></h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
