...
const AIMatchesHub = lazy(() => import('@/components/crm/matches').then(m => ({ default: m.AIMatchesHub })));
const SessionsHub = lazy(() => import('@/components/crm/sessions').then(m => ({ default: m.SessionsHub })));
