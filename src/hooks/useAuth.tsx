...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, role: 'artist' | 'engineer') => Promise<void>;
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const signUp = async (email: string, password: string, fullName: string, role: 'artist' | 'engineer') => {
    try {
