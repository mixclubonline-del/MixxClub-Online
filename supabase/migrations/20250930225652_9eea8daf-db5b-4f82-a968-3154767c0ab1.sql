...
DROP POLICY IF EXISTS "Users can view their sessions" ON public.collaboration_sessions;
...
-- ============================================
-- Part 4: Migrate existing users to new role system
-- ============================================

-- Insert admin roles for existing users with admin role in profiles
