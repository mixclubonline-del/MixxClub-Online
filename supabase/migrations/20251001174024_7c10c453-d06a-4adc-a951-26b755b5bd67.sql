...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS %I ON session_participants', policy_record.policyname);
    END LOOP;
END $$;
...
BEGIN
    FOR policy_record IN 
        ...
        AND schemaname = 'public'
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS %I ON job_postings', policy_record.policyname);
    END LOOP;
END $$;
