...
-- Phase 2: Performance Optimization - Strategic Indexes (Revised)
...
-- Engineer badges
CREATE INDEX IF NOT EXISTS idx_engineer_badges_engineer ON public.engineer_badges(engineer_id);
CREATE INDEX IF NOT EXISTS idx_engineer_badges_rarity ON public.engineer_badges(badge_rarity);
